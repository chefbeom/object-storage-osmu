...
- Operations handoff package chargeback closeout visibility: operationsHandoffPackage.chargebackCloseoutSnapshot가 있으면 readiness panel은 closeout result, billing period, final invoice count, paid invoice count, reconciliation difference, no-raw-data flag를 handoff package snapshot summary로 표시한다.
