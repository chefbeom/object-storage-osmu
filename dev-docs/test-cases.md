...
- Priority: P1
- Automated: backend S3 controller tests including `S3ObjectControllerTest.multiDeleteRejectsUnexpectedRootXml`, and `verify-s3-client-smoke.ps1`; document consistency is reviewed through `git diff --check` and code review.
