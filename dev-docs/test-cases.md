...
- Expected: The matrix lists supported, partial, and unsupported behavior, including the distinction between aws-chunked body decoding with decoded length validation and missing per-chunk signature/trailer checksum parity.
- Priority: P1
