...
OSMU_ACCESS_KEY_MC_PATH=/opt/osmu-tools/mc
...
OSMU_BOOTSTRAP_ADMIN_ENABLED=true
OSMU_BOOTSTRAP_ADMIN_ALLOW_DEFAULT_CREDENTIALS=true
...
VITE_MULTIPART_UPLOAD_THRESHOLD_BYTES=134217728
VITE_MULTIPART_UPLOAD_PART_SIZE_BYTES=67108864
...
.\scripts\verify-s3-client-smoke.ps1 -Client boto3 -RequireClient
.\scripts\verify-s3-client-smoke.ps1 -Client aws-js -RequireClient
