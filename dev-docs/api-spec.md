...
```json
{
  "data": {
    ...
    "severitySummaries": [
      { "severity": "WARNING", "count": 13 }
    ],
    "categorySummaries": [
      { "category": "OPERATIONS", "totalCount": 13, "blockerCount": 0, "warningCount": 13 }
    ],
    "items": [
      {
        "severity": "WARNING",
