...
```json
{
  "data": {
    ...
    "operationsHandoffPackage": {
      ...
      "decisionRule": "Production/B2B operations handoff package readiness requires result=passed and, when required, ready operations readiness/convergence plus passed data-flow/commercial snapshots.",
