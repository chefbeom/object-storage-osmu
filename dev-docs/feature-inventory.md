...
- Remaining billing/chargeback scope is native card/bank/tax/ERP provider API adapters, production secret rotation evidence, and real integration verification; approved commercial price-list reference recording, notification webhook/Slack/EMAIL SMTP relay send, generic/CARD/BANK/TAX/ERP payment webhook profile send, private/local webhook URL/SMTP relay host blocking, outbound payload size caps, and generic notification/payment webhook HMAC signature headers are implemented.
