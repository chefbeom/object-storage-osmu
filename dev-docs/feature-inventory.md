...
- `scripts/write-data-flow-storage-plan.ps1` records the sizing, no-object-key aggregate policy, backfill, rollback, dashboard cutover, retention budget, and query-plan/target-store evidence checklist for the future partition/time-series transition.
