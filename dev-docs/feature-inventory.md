...
- full AWS multipart checksum negotiation parity beyond stored UploadPart checksum metadata and complete-time matching guards, especially remaining exact AWS response propagation and remaining special errors
