...
| `GET/PUT/DELETE Bucket lifecycle` | MVP supported | S3 XML lifecycle subset mapped to OSMU lifecycle rules. Missing configuration returns `NoSuchLifecycleConfiguration`; missing or blank XML body returns `MissingRequestBodyError`. |
