...
| Multipart initiate/upload/list/complete/abort | MVP supported | Requires OSMU expected-size header for quota/session planning. Unknown-size AWS initiate parity is not supported. |
