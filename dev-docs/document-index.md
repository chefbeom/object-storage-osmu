...
- `../scripts/verify-operations-handoff-package.ps1` - self-test the operations handoff package writer, passed package shape, readiness/convergence/data-flow storage plan snapshot parsing, required snapshot failure, credential-like reference/snapshot rejection, unsafe raw operations snapshot rejection, and unsafe raw SQL data-flow snapshot rejection.
