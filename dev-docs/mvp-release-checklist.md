...
- Latest storage backend telemetry evidence: `.osmu-run/latest-storage-backend-telemetry.json` when target MinIO `mc admin info --json` pool/node evidence has been summarized.
