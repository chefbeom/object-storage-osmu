...
- Data-flow operations analytics: detailed/daily/materialized rollup surfaces plus long-term monthly aggregate JSON/CSV are implemented for internal operators. This is not AWS billing parity and still needs a dedicated partitioned or time-series repository before high-volume commercial operations.
