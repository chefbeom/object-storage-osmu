...
- The surfaced `dataFlowStoragePlan` includes `targetP95QueryLatencyMs`, and the handoff package snapshot carries the same budget with query-plan evidence summary.
