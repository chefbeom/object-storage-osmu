...
- The same artifact import verification also covers data-flow transition runbook promotion and rejects runbook snapshots containing raw SQL, raw EXPLAIN, object keys, raw event messages, or credential-shaped content.
