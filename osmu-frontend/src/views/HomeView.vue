...
function normalizeOperationsHandoffPackage(report = {}) {
  return {
    ...
    dataFlowStoragePlanSnapshot: report?.dataFlowStoragePlanSnapshot && typeof report.dataFlowStoragePlanSnapshot === 'object' ? report.dataFlowStoragePlanSnapshot : {},
    dataFlowStorageTransitionRunbookSnapshot: report?.dataFlowStorageTransitionRunbookSnapshot && typeof report.dataFlowStorageTransitionRunbookSnapshot === 'object' ? report.dataFlowStorageTransitionRunbookSnapshot : {},
