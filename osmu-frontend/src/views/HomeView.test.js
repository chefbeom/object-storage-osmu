...
test('HomeView exposes stable selectors for browser E2E flows', () => {
  ...
  assert.match(dashboardSource, /queryWorkflowCount/)
  assert.match(dashboardSource, /queryExecutedCount/)
  assert.match(dashboardSource, /candidateCount/)
  assert.match(dashboardSource, /githubApiUnauthenticated/)
  ...
  assert.match(dashboardSource, /operationsEvidenceHandoffInputFreeBlockedActions/)
  assert.match(dashboardSource, /readiness-evidence-handoff-input-free-actions/)
  assert.match(dashboardSource, /readiness-evidence-handoff-input-free-review-command-copy-button/)
  assert.match(dashboardSource, /formatEvidenceHandoffInputFreeBlockedActionMeta/)
  assert.match(dashboardSource, /operationsEvidenceHandoffOperatorInputSummary/)
  assert.match(dashboardSource, /operationsEvidenceHandoffOperatorInputProfileSummary/)
  assert.match(dashboardSource, /operationsEvidenceHandoffOperatorInputNonReadyActions/)
  assert.match(dashboardSource, /readiness-evidence-handoff-operator-input-values/)
  assert.match(dashboardSource, /readiness-evidence-handoff-operator-input-profile/)
  assert.match(dashboardSource, /readiness-evidence-handoff-operator-input-profile-command/)
  assert.match(dashboardSource, /readiness-evidence-handoff-operator-input-check-command/)
  assert.match(dashboardSource, /readiness-evidence-handoff-operator-input-actions/)
  assert.match(dashboardSource, /formatOperatorInputValueActionMeta/)
  ...
  assert.match(dashboardSource, /requiredGitHubSecretCount: Number\(handoff\?\.requiredGitHubSecretCount \|\| 0\)/)
  assert.match(dashboardSource, /requiredGitHubSecrets: Array\.isArray\(handoff\?\.requiredGitHubSecrets\)/)
  assert.match(dashboardSource, /requiredGitHubSecretSummaries: Array\.isArray\(handoff\?\.requiredGitHubSecretSummaries\)/)
  assert.match(dashboardSource, /operationsEvidenceHandoffRequiredSecretsSummary/)
  assert.match(dashboardSource, /readiness-evidence-handoff-required-secrets/)
  assert.match(dashboardSource, /inputFreeBlockedReviewReportExists: Boolean\(handoff\?\.inputFreeBlockedReviewReportExists\)/)
  assert.match(dashboardSource, /inputFreeBlockedActions: Array\.isArray\(handoff\?\.inputFreeBlockedActions\)/)
  ...
  assert.match(dashboardSource, /handoffRequiredGitHubSecretCount: Number\(report\?\.handoffRequiredGitHubSecretCount \|\| 0\)/)
  assert.match(dashboardSource, /handoffRequiredGitHubSecrets: Array\.isArray\(report\?\.handoffRequiredGitHubSecrets\)/)
  assert.match(dashboardSource, /handoffRequiredGitHubSecretSummaries: Array\.isArray\(report\?\.handoffRequiredGitHubSecretSummaries\)/)
  assert.match(dashboardSource, /operationsReadinessConvergenceRequiredSecretsSummary/)
  assert.match(dashboardSource, /readiness-convergence-required-secrets/)
  ...
  assert.match(dashboardSource, /operatorInputValuesProfileReportPath: handoff\?\.operatorInputValuesProfileReportPath/)
  assert.match(dashboardSource, /operatorInputValuesProfileExists: Boolean\(handoff\?\.operatorInputValuesProfileExists\)/)
  assert.match(dashboardSource, /operatorInputValuesProfileDefaultsSkipped: Boolean\(handoff\?\.operatorInputValuesProfileDefaultsSkipped\)/)
  assert.match(dashboardSource, /operatorInputValuesProfileDefaultsSkipReason: handoff\?\.operatorInputValuesProfileDefaultsSkipReason/)
  assert.match(dashboardSource, /operatorInputValuesProfileBlankValueCount: Number\(handoff\?\.operatorInputValuesProfileBlankValueCount \|\| 0\)/)
  assert.match(dashboardSource, /operatorInputValuesProfileCommand: handoff\?\.operatorInputValuesProfileCommand/)
  assert.match(dashboardSource, /operatorInputValuesCheckCommand: handoff\?\.operatorInputValuesCheckCommand/)
  assert.match(dashboardSource, /operatorInputValuesCheckResult: handoff\?\.operatorInputValuesCheckResult/)
  assert.match(dashboardSource, /operatorInputValuesCheckNonReadyActionSummaries: normalizeOperationsInputValueActionSummaries\(handoff\?\.operatorInputValuesCheckNonReadyActionSummaries\)/)
  assert.match(dashboardSource, /handoffOperatorInputValuesProfileReportPath: report\?\.handoffOperatorInputValuesProfileReportPath/)
  assert.match(dashboardSource, /handoffOperatorInputValuesProfileExists: Boolean\(report\?\.handoffOperatorInputValuesProfileExists\)/)
  assert.match(dashboardSource, /handoffOperatorInputValuesProfileDefaultsSkipped: Boolean\(report\?\.handoffOperatorInputValuesProfileDefaultsSkipped\)/)
  assert.match(dashboardSource, /handoffOperatorInputValuesProfileDefaultsSkipReason: report\?\.handoffOperatorInputValuesProfileDefaultsSkipReason/)
  assert.match(dashboardSource, /handoffOperatorInputValuesProfileBlankValueCount: Number\(report\?\.handoffOperatorInputValuesProfileBlankValueCount \|\| 0\)/)
  assert.match(dashboardSource, /handoffOperatorInputValuesCheckResult: report\?\.handoffOperatorInputValuesCheckResult/)
  assert.match(dashboardSource, /handoffOperatorInputValuesCheckNonReadyActionSummaries: normalizeOperationsInputValueActionSummaries\(report\?\.handoffOperatorInputValuesCheckNonReadyActionSummaries\)/)
  assert.match(dashboardSource, /operationsReadinessConvergenceInputFreeReviewSummary/)
  assert.match(dashboardSource, /operationsReadinessConvergenceOperatorInputSummary/)
  assert.match(dashboardSource, /operationsReadinessConvergenceOperatorInputProfileSummary/)
  assert.match(dashboardSource, /operationsReadinessConvergenceOperatorInputNonReadyActions/)
  assert.match(dashboardSource, /readiness-convergence-input-free-review/)
  assert.match(dashboardSource, /readiness-convergence-operator-input-values/)
  assert.match(dashboardSource, /readiness-convergence-operator-input-profile/)
  assert.match(dashboardSource, /readiness-convergence-operator-input-actions/)
