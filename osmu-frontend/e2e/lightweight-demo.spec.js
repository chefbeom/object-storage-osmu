...
test('admin can complete lightweight storage portal click path', async ({ page }) => {
  ...
  await adminProfileRequestRow.getByTestId('admin-storage-profile-approve-button').click()
  ...
  await adminProfileRequestRow.getByTestId('admin-storage-profile-apply-button').click()
