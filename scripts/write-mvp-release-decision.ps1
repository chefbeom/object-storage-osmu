...
$decisionLines = @(
    ...
    (Gate-Line $realS3PilotGate "Real S3 client required and available" "realS3ClientRequired=$($scope.realS3ClientRequired), aws=$($optionalGates.awsCliAvailable), boto3=$($optionalGates.boto3Available), awsJsSdk=$($optionalGates.awsJsSdkAvailable), mc=$($optionalGates.mcAvailable), dockerizedMc=$($optionalGates.dockerizedMcAvailable)"),
