...
function Assert-SanitizedEnterpriseAuthJitRollbackJson([string] $Value, [string] $Label) {
    if ([string]::IsNullOrWhiteSpace($Value)) {
        return
    }
