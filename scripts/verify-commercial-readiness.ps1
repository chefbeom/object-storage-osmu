...
Assert-Contains $content 'native card/bank/tax/ERP provider API adapters, target secret/certificate rotation `result=passed` evidence, and target commercial integration `result=passed` evidence remain pending.' "Commercial readiness draft"
