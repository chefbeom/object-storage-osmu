...
Assert-Contains $content 'Operations readiness artifact import report is generated as `.osmu-run/latest-operations-readiness-artifact-import.json` when evidence is assembled from prior workflow or manual evidence artifacts, including commercial approval and enterprise auth smoke evidence when provided.' "Commercial readiness draft"
