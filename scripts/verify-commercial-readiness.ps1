...
Assert-Contains $content 'commercial integration evidence writer implemented' "Commercial readiness draft"
Assert-Contains $content 'operations handoff package evidence writer implemented' "Commercial readiness draft"
Assert-Contains $content 'native card/bank/tax/ERP provider API adapters, target secret/certificate rotation `result=passed` evidence, target commercial integration `result=passed` evidence, and target operations handoff package `result=passed` evidence remain pending.' "Commercial readiness draft"
