...
Assert-Contains $content 'Operations readiness artifact import report is generated as `.osmu-run/latest-operations-readiness-artifact-import.json` when evidence is assembled from prior workflow or manual evidence artifacts, including commercial approval, enterprise auth smoke, and operations handoff package evidence when provided.' "Commercial readiness draft"
