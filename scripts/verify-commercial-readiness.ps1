...
Assert-Contains $content 'payment provider handoff outbox/history with adapter retry state and configured webhook handoff send' "Commercial readiness draft"
Assert-Contains $content 'card/bank/tax/ERP-specific provider adapters and raw provider response storage remain out of scope.' "Commercial readiness draft"
...
Assert-Contains $content 'card/bank/tax/ERP-specific provider adapters, production secret rotation evidence, and real integration verification remain pending.' "Commercial readiness draft"
