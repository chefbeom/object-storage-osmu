...
Assert-Contains $content '- Chargeback preview: API, persistent pricing policy, Admin billing panel, scoped threshold alerts, scoped notification payload preview, scoped preview CSV export, and draft invoice CSV export implemented; finalized invoice approval/persistence, approved pricing workflow, and actual external notification delivery adapters remain pending.' "Commercial readiness draft"
