...
Assert-Contains $content '- Chargeback preview: API, persistent pricing policy, Admin billing panel, scoped threshold alerts, scoped notification payload preview, scoped notification outbox/history, scoped preview CSV export, and draft invoice CSV export implemented; finalized invoice approval/persistence, approved pricing workflow, actual external notification delivery adapters, retry worker, and secret storage remain pending.' "Commercial readiness draft"
