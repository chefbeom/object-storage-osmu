...
Assert-Contains $content 'native card/bank/tax/ERP provider API adapters, production secret rotation evidence, and real integration verification remain pending.' "Commercial readiness draft"
