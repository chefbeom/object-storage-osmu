...
Assert-Contains $matrix 'GET /api/admin/monitoring/data-flow/storage-status' "IAM/RBAC matrix"
Assert-Contains $matrix 'GET /api/admin/storage/backend-status' "IAM/RBAC matrix"
...
Assert-Contains $apiSpec 'includeMonthlyRollups' "API spec"
Assert-Contains $apiSpec 'monthlyRollupRetention' "API spec"
...
Assert-Contains $homeView 'getDataFlowStorageStatus' "HomeView"
Assert-Contains $homeView 'getStorageBackendStatus' "HomeView"
Assert-Contains $homeView 'storageBackendStatus' "HomeView"
Assert-Contains $homeView ':storage-backend-status="storageBackendStatus"' "HomeView"
...
Assert-Contains $homeView 'includeMonthlyRollups' "HomeView"
Assert-Contains $homeView 'monthlyRollupRetention' "HomeView"
Assert-Contains $homeView 'dataFlowStorageStatus' "HomeView"
