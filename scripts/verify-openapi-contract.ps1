...
$requiredOperations = @(
    ...
    @("/api/buckets/{bucketName}/versioning", "get", "getBucketVersioning"),
    @("/api/buckets/{bucketName}/versioning", "put", "putBucketVersioning"),
    ...
    @("/api/admin/monitoring/data-flow/retention/run", "post", "runDataFlowRetention"),
    ...
    @("/api/admin/monitoring/data-flow/daily-rollup/materialized/export.csv", "get", "downloadMaterializedDataFlowDailyRollupCsv"),
    @("/api/admin/monitoring/data-flow/daily-rollup/export.csv", "get", "downloadDataFlowDailyRollupCsv"),
    @("/api/admin/monitoring/data-flow/monthly-rollup", "get", "getDataFlowMonthlyRollup"),
    @("/api/admin/monitoring/data-flow/monthly-rollup/materialize", "post", "materializeDataFlowMonthlyRollup"),
    @("/api/admin/monitoring/data-flow/monthly-rollup/materialized", "get", "getMaterializedDataFlowMonthlyRollup"),
    @("/api/admin/monitoring/data-flow/monthly-rollup/export.csv", "get", "downloadDataFlowMonthlyRollupCsv"),
    @("/api/admin/monitoring/data-flow/monthly-rollup/materialized/export.csv", "get", "downloadMaterializedDataFlowMonthlyRollupCsv"),
    ...
    @("/api/admin/storage/backend-status", "get", "getStorageBackendStatus"),
