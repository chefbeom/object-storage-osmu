...
Assert-Equal $actionReport.handoffInputFreeBlockedReviewReportJsonPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json" "action input-free aggregate review report json path"
Assert-Equal $actionReport.handoffInputFreeBlockedReviewReportMarkdownPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md" "action input-free aggregate review report markdown path"
