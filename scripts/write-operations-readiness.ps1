...
$commercialApprovalRemediation = New-Remediation `
    ...
    "gh workflow run manual-commercial-approval-evidence.yml -f product_version=<version> -f approval_ref=<approval-ref> -f approved_by=<approver> -f approved_at=<iso-time> -f pricing_approval_ref=<ref> -f terms_approval_ref=<ref> -f support_sla_approval_ref=<ref> -f license_agreement_ref=<ref> -f legal_approval_ref=<ref> -f pilot_contract_ref=<ref> -f confirm_pricing_approved=true -f confirm_terms_approved=true -f confirm_support_sla_approved=true -f confirm_license_approved=true -f confirm_legal_approved=true -f confirm_no_secret_values=true -f fail_if_not_passed=true" `
