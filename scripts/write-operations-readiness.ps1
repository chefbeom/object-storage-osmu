...
$operationsHandoffPackageRemediation = New-Remediation `
    ...
    "" `
    "" `
    "Run at pilot or production handoff after the operator has reviewed runbook, troubleshooting, rollback, support escalation, known gaps, and target evidence. The package stores references and booleans only; do not pass passwords, bearer tokens, kubeconfig values, private keys, provider credentials, raw provider responses, or customer payment data."
