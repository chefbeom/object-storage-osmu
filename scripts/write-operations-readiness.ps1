...
$report = [ordered]@{
    ...
    checks = $checks
    decisionRule = "Production/B2B operations readiness is ready only when every listed static, automation, live Kubernetes, storage expansion, HA/DR, and security evidence check is PASS."
}
