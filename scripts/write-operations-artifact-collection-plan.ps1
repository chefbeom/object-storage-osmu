...
if ($hasCommercialIntegrationEvidence) {
    Add-Artifact $artifacts "commercial-integration" "manual-commercial-integration-evidence.yml" $commercialIntegrationRun "commercial_integration_run_id" "commercial-integration-evidence-$commercialIntegrationRun" "commercial_integration_artifact_name" ".osmu-run/operations-readiness-artifacts/commercial-integration" $true "Imports latest-commercial-integration-evidence.json from target notification/payment handoff adapter evidence."
}
