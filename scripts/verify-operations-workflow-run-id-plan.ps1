...
Assert-Equal ([bool] $planOnly.queryExecuted) $false "plan-only query executed"
Assert-Equal $planOnly.queryExecutedCount 0 "plan-only query executed count"
Assert-Equal $planOnly.queryWorkflowCount 23 "plan-only query workflow count"
Assert-Equal $planOnly.querySucceededCount 23 "plan-only query succeeded count"
Assert-Equal $planOnly.queryErrorCount 0 "plan-only query error count"
Assert-Equal $planOnly.candidateCount 0 "plan-only candidate count"
...
Assert-Contains $planOnlyMarkdown "Query executed: False" "plan-only markdown query executed"
Assert-Contains $planOnlyMarkdown "Query execution count: 0/23" "plan-only markdown query execution count"
Assert-Contains $planOnlyMarkdown "Query success count: 23/23" "plan-only markdown query success count"
Assert-Contains $planOnlyMarkdown "Candidate runs: 0" "plan-only markdown candidate runs"
...
Assert-Equal ([bool] $ready.queryExecuted) $true "ready query executed"
Assert-Equal $ready.queryExecutedCount 23 "ready query executed count"
Assert-Equal $ready.queryWorkflowCount 23 "ready query workflow count"
Assert-Equal $ready.querySucceededCount 23 "ready query succeeded count"
Assert-Equal $ready.queryErrorCount 0 "ready query error count"
Assert-Equal $ready.candidateCount 23 "ready candidate count"
...
Assert-Contains $readyMarkdown "Query executed: True" "ready markdown query executed"
Assert-Contains $readyMarkdown "Query execution count: 23/23" "ready markdown query execution count"
Assert-Contains $readyMarkdown "Query success count: 23/23" "ready markdown query success count"
Assert-Contains $readyMarkdown "Candidate runs: 23" "ready markdown candidate runs"
...
Assert-Equal ([bool] $securityOnly.queryExecuted) $false "security-only query executed"
Assert-Equal $securityOnly.queryExecutedCount 0 "security-only query executed count"
Assert-Equal $securityOnly.queryWorkflowCount 1 "security-only query workflow count"
Assert-Equal $securityOnly.querySucceededCount 1 "security-only query succeeded count"
Assert-Equal $securityOnly.queryErrorCount 0 "security-only query error count"
Assert-Equal $securityOnly.candidateCount 0 "security-only candidate count"
