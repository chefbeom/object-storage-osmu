...
Write-RunListFixture "manual-secret-rotation-evidence.yml" 107 $sha
Write-RunListFixture "manual-commercial-integration-evidence.yml" 108 $sha
Write-RunListFixture "manual-commercial-approval-evidence.yml" 109 $sha
Write-RunListFixture "enterprise-auth-smoke-ci.yml" 110 $sha
Write-RunListFixture "manual-operations-handoff-package.yml" 111 $sha
Write-RunListFixture "kubernetes-operations-report-sync-ci.yml" 112 $sha
...
Assert-Equal $planOnly.workflowCount 12 "plan-only workflow count"
Assert-Equal $planOnly.missingWorkflowCount 12 "plan-only missing workflow count"
...
Assert-Equal $ready.readyWorkflowCount 12 "ready workflow count"
...
Assert-Contains $ready.artifactCollectionPlanCommand "-SecretRotationRunId 107" "secret rotation run id argument"
Assert-Contains $ready.artifactCollectionPlanCommand "-CommercialIntegrationRunId 108" "commercial integration run id argument"
Assert-Contains $ready.artifactCollectionPlanCommand "-CommercialApprovalRunId 109" "commercial approval run id argument"
Assert-Contains $ready.artifactCollectionPlanCommand "-EnterpriseAuthRunId 110" "enterprise auth run id argument"
Assert-Contains $ready.artifactCollectionPlanCommand "-OperationsHandoffPackageRunId 111" "operations handoff package run id argument"
Assert-Contains $ready.artifactCollectionPlanCommand "-KubernetesOperationsReportSyncRunId 112" "Kubernetes operations report sync run id argument"
...
Assert-Contains $readyMarkdown "secret-rotation-evidence-107" "ready markdown secret rotation artifact"
Assert-Contains $readyMarkdown "commercial-integration-evidence-108" "ready markdown commercial integration artifact"
Assert-Contains $readyMarkdown "commercial-approval-evidence-109" "ready markdown commercial approval artifact"
Assert-Contains $readyMarkdown "enterprise-auth-smoke-110" "ready markdown enterprise auth artifact"
Assert-Contains $readyMarkdown "operations-handoff-package-111" "ready markdown operations handoff package artifact"
Assert-Contains $readyMarkdown "kubernetes-operations-report-sync-112" "ready markdown Kubernetes operations report sync artifact"
