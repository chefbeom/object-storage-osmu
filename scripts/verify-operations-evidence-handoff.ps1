...
Assert-Equal $inputFreeOnlyReport.nextStep.command "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite" "input-free-only safe review next step command"
Assert-Contains $inputFreeOnlyReport.nextStep.reason "require no operator input values" "input-free-only next step reason"
Assert-Contains $inputFreeOnlyReport.nextStep.note "Execute only after the confirmed plan is reviewed" "input-free-only execute note"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedActionCount 1 "input-free-only input-free count"
Assert-Equal (@($inputFreeOnlyReport.inputFreeBlockedActionOrders) -join ",") "1" "input-free-only action orders"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedReviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite" "input-free-only review command"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedReviewReportCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -JsonOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json -MarkdownOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md" "input-free-only review report command"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedReviewReportJsonPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json" "input-free-only review report json path"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedReviewReportMarkdownPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md" "input-free-only review report markdown path"
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedConfirmedPlanCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -KubeconfigSecretConfirmed -ConfirmOperatorApproval" "input-free-only confirmed plan command"
Assert-Equal @($inputFreeOnlyReport.inputFreeBlockedActions)[0].reviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite" "input-free-only action review command"
Assert-Equal @($inputFreeOnlyReport.inputFreeBlockedActions)[0].confirmedPlanCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -KubeconfigSecretConfirmed -ConfirmOperatorApproval" "input-free-only action confirmed plan command"
Assert-Contains $inputFreeOnlyMarkdown "Action orders: 1" "input-free-only markdown action orders"
Assert-Contains $inputFreeOnlyMarkdown "Review report command: ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -JsonOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json -MarkdownOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md``" "input-free-only markdown review report command"
Assert-Contains $inputFreeOnlyMarkdown "Review input-free blocked confirmations" "input-free-only markdown next step"
...
Assert-Equal (@($blockedReport.inputFreeBlockedActionOrders) -join ",") "1" "blocked input-free action orders"
Assert-Equal $blockedReport.inputFreeBlockedReviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite" "blocked input-free review command"
Assert-Equal $blockedReport.inputFreeBlockedReviewReportCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -JsonOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json -MarkdownOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md" "blocked input-free review report command"
Assert-Equal $blockedReport.inputFreeBlockedReviewReportJsonPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json" "blocked input-free review report json path"
Assert-Equal $blockedReport.inputFreeBlockedReviewReportMarkdownPath ".\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md" "blocked input-free review report markdown path"
Assert-Equal $blockedReport.inputFreeBlockedConfirmedPlanCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -KubeconfigSecretConfirmed -ConfirmOperatorApproval" "blocked input-free confirmed plan command"
...
Assert-Equal @($blockedReport.inputFreeBlockedActions)[0].reviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite" "blocked input-free action review command"
Assert-Equal @($blockedReport.inputFreeBlockedActions)[0].confirmedPlanCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -KubeconfigSecretConfirmed -ConfirmOperatorApproval" "blocked input-free action confirmed plan command"
...
Assert-Contains @($blockedReport.inputFreeBlockedActions)[0].planCommand "-KubeconfigSecretConfirmed" "blocked input-free confirmed plan command"
...
Assert-Contains $blockedMarkdown "Review command before confirmations: ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -NoWrite``" "blocked markdown input-free aggregate review command"
Assert-Contains $blockedMarkdown "Review report command: ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -JsonOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.json -MarkdownOutputPath .\.osmu-run\input-free-blocker-review\operations-evidence-plan-invocation.md``" "blocked markdown input-free review report command"
Assert-Contains $blockedMarkdown "Confirmed plan command: ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1 -KubeconfigSecretConfirmed -ConfirmOperatorApproval``" "blocked markdown input-free aggregate confirmed plan command"
