...
Assert-Equal $inputFreeOnlyReport.nextStep.command "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1" "input-free-only safe review next step command"
...
Assert-Equal $inputFreeOnlyReport.inputFreeBlockedReviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1" "input-free-only review command"
Assert-Equal @($inputFreeOnlyReport.inputFreeBlockedActions)[0].reviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1" "input-free-only action review command"
...
Assert-Equal $blockedReport.inputFreeBlockedReviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1" "blocked input-free review command"
...
Assert-Equal @($blockedReport.inputFreeBlockedActions)[0].reviewCommand "powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1" "blocked input-free action review command"
...
Assert-Contains $blockedMarkdown "Review command before confirmations: ``powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\invoke-operations-evidence-plan.ps1 -ActionOrder 1``" "blocked markdown input-free aggregate review command"
