...
public class StorageProfileController {
    ...
    public ListResponse<StorageProfileRequestResponse> listRequests(HttpServletRequest request) {
        AuthenticatedUser user = authContext.currentUser(request);
        return ListResponse.of(storageProfileService.listVisibleRequests(user));
    }
