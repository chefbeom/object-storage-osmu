...
- data-flow daily rollup, materialized daily rollup store, monthly aggregate JSON/CSV, monthly aggregate store 기반 장기 analytics를 운영 화면에서 제공하고, 다음 단계에서 partition 또는 전용 time-series 저장소로 확장한다.
