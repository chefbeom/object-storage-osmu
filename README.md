...
- S3 parity 확대: 남은 AWS multipart checksum 협상/real-client option 세부 동작, generic digest/large/conflict/internal 이후 남은 non-bucket error message/status nuance.
