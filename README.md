...
- MinIO pool/node telemetry는 evidence writer로 시작했으며, 다음 단계는 storage expansion finalizer와 dashboard/backend 상태 API에 자동 연결하는 것이다.
